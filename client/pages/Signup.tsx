...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!selectedRole || !email || !password || !confirmPassword) {
    ...
    setIsLoading(true);
    try {
      await signup(email, password, selectedRole, email.split('@')[0]);
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Submit & validate ideas</div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Discover & evaluate ideas</div>
                  </button>
                </div>
              </div>
